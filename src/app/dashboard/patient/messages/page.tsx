...
export default async function MessagesPage() {
  ...
  const conversations = [
    { id: "C1", name: "CareVerse Clinic (Dr. Vance)", lastMsg: "Please continue the cough syrup as needed...", time: "10:15 AM", unread: false },
  ];

  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "2rem", height: "100%", width: "100%", maxWidth: "1200px", margin: "0 auto", maxHeight: "calc(100vh - 4rem)" }}>
      ...
      <div className="glass-panel" style={{ flex: 1, padding: 0, display: "flex", overflow: "hidden", minHeight: "500px" }}>
        ...
        <div style={{ width: "320px", borderRight: "1px solid rgba(255,255,255,0.1)", display: "flex", flexDirection: "column", background: "rgba(255,255,255,0.02)" }}>
          <div style={{ padding: "1.25rem", borderBottom: "1px solid rgba(255,255,255,0.1)" }}>
            <h3 style={{ fontSize: "1rem", fontWeight: 600 }}>Your Care Team</h3>
          </div>
          ...
          <div style={{ flex: 1, overflowY: "auto" }}>
            {conversations.map((conv) => (
              <div key={conv.id} style={{ 
                ...
                gap: "1rem",
                cursor: "pointer",
                background: "rgba(255,255,255,0.05)", // Selected state
                borderLeft: "3px solid var(--accent-aqua)" // Selected state
              }}>
                <div style={{ position: "relative" }}>
                  <div style={{ width: "48px", height: "48px", borderRadius: "50%", background: "var(--bg-deep)", color: "var(--text-bright)", border: "1px solid var(--accent-aqua)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: "bold", fontSize: "1.25rem" }}>
                    CV
                  </div>
                  {conv.unread && (
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", background: "transparent" }}>
          ...
          <div style={{ padding: "1.25rem 1.5rem", borderBottom: "1px solid rgba(255,255,255,0.1)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
              <div style={{ width: "40px", height: "40px", borderRadius: "50%", background: "var(--bg-deep)", color: "var(--text-bright)", border: "1px solid var(--accent-aqua)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: "bold", fontSize: "1.25rem" }}>
                CV
              </div>
              <div>
                <div style={{ fontWeight: 600, fontSize: "1rem" }}>CareVerse Clinic (Dr. Vance)</div>
                <div style={{ fontSize: "0.75rem", color: "var(--accent-aqua)" }}>Online</div>
              </div>
            </div>
          ...
          <div style={{ flex: 1, padding: "1.5rem", overflowY: "auto", display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            ...
            <div style={{ display: "flex", gap: "1rem", maxWidth: "80%", alignSelf: "flex-end", flexDirection: "row-reverse" }}>
              ...
              <div>
                ...
                <div style={{ fontSize: "0.6875rem", color: "var(--text-muted)", marginTop: "0.25rem", marginRight: "0.5rem", textAlign: "right" }}>9:45 AM • Read</div>
              </div>
            </div>

            {/* Clinic Message */}
            <div style={{ display: "flex", gap: "1rem", maxWidth: "80%" }}>
              <div style={{ width: "32px", height: "32px", flexShrink: 0, borderRadius: "50%", background: "var(--bg-deep)", color: "var(--text-bright)", border: "1px solid var(--accent-aqua)", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: "bold", fontSize: "0.875rem" }}>
                CV
              </div>
              <div>
                ...
                <div style={{ fontSize: "0.6875rem", color: "var(--text-muted)", marginTop: "0.25rem", marginLeft: "0.5rem" }}>10:15 AM</div>
              </div>
            </div>
